"""
TieOut orchestrator -- one command runs the whole loop and emits everything.
...
<title>TieOut — Reconciliation Report</title>
...
<h1>TieOut — settlement reconciliation report</h1>
...
<p class="foot">Generated by TieOut · bounded &amp; gated: the AI proposes, never edits money · full trail in audit.csv</p>
</div></body></html>"""
